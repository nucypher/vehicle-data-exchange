...
def generate_car_simulation_samples ( policy_pubkey, label: bytes = DEFAULT_LABEL, save_as_file: bool = False, send_by_mqtt: bool = False ):
	...
	sessionPath = "UMA-5_10_17-Simulation.db"
